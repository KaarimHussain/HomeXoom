...
<head>
    ...
    <title>Listing - <?php echo TTITLE; ?></title>
    <link rel="stylesheet" href="<?php echo STYLES_URL ?>/listing.css?v=<?php echo time(); ?>">
</head>

<body>
    <?php include COMPONENT_DIR . "/header.php"; ?>
    <main class="hero-section flex items-center justify-center flex-col py-20">
        <h1 class="text-primary-foreground text-5xl sm:text-7xl font-prata">Find a <span
                class="text-primary-color font-prata">Listing</span>
        </h1>
